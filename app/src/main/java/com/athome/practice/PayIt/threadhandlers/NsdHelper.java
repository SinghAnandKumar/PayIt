...
public class NsdHelper {
    ...
    private static final String mServiceBaseName = "paayit";
...
//                        mainThreadListener.notifyDiscoveredOneItem(serviceInfo);
                        mainThreadListener.onServiceResolved(serviceInfo);
                    }
                });
            }
...
//                debug("entered onServiceRegistered -- \n Registered ServiceInfo = [ " + serviceInfo + " ]");
                ...
                mainThreadListener.notifyRegistrationComplete(serviceInfo);
            }
    ...
    private void initDiscoveryListener() {
        discoveryListener = new NsdManager.DiscoveryListener() {
            ...
            public void onServiceLost(NsdServiceInfo serviceInfo) {
                ...
                mainThreadListener.onServiceLost(serviceInfo);
            }
...
//              DEBUG  temp relax to allow self loop messaging
                ...
                } else if (service.getServiceName().contains(mServiceBaseName)) {
                    ...
                    mainThreadListener.onServiceDiscovered(service);
                }
            }
    ...
    public void registerService(String serviceName, int port) {
        this.serviceName = mServiceBaseName + "." + serviceName;
