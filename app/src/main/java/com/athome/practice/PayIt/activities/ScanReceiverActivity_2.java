...
import com.athome.practice.PayIt.threadhandlers.NsdHelper;
import com.athome.practice.PayIt.physical.TokenSendReceivePhysical;
import com.athome.practice.PayIt.threadhandlers.interfaces.NsdHelperListener;
...
public class ScanReceiverActivity_2 extends AppCompatActivity implements NsdHelperListener, TokenSendReceivePhysical.TokenPhysicalCallback {
    ...
    private void init() {
        ...
        nsdHelper = new NsdHelper(this,mainHandler,this);
    ...
    @Override
    public void notifyRegistrationComplete(NsdServiceInfo nsdItem) {
        Toast.makeText(this,"Service registered : "+nsdItem.getServiceName(),Toast.LENGTH_SHORT);
    }

    @Override
    public void onServiceDiscovered(NsdServiceInfo service) {
        Toast.makeText(this, "Discovered service : "+ service.getServiceName(), Toast.LENGTH_SHORT).show();
...
//        } else if(hmIsServiceReady.containsKey(beneficiaryName) && !hmIsServiceReady.get(beneficiaryName)) {
////            nsdHelper.resolveService(service);
//        }
    ...
    public void onServiceResolved(NsdServiceInfo service) {
        ...
        Toast.makeText(this, "Resolved service : "+ service.getServiceName(), Toast.LENGTH_SHORT).show();
//        String beneficiaryName = service.getServiceName()==null?"NA":service.getServiceName();
    ...
    public void onServiceLost(NsdServiceInfo service) {
        Toast.makeText(this, "Lost service service : "+ service.getServiceName(), Toast.LENGTH_SHORT).show();
    ...
    public void onDiscoveryStopped(String s) {
        Toast.makeText(this, "Discovery stopped : "+ s, Toast.LENGTH_SHORT).show();
